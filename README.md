...
## 💫 ᴀʙᴏᴜᴛ ᴍᴇ:
Better known as lemoonchild ✨, a passionate **Computer Science and Information Technology Engineering student at Universidad del Valle de Guatemala (UVG)**, currently in my fifth year (10th semester), expected to graduate in May 2027.

I work as a **Fullstack Developer at GLIFOS**, where I build custom software solutions for clients using React, React Native, and PHP (Yii), handle server deployment on Ubuntu and Windows Server, and provide technical support. I also designed and developed the frontend for **SANITAS**, an academic project: a clinical records management system for the UVG community.
...
## 💻 ​🇼​​🇭​​🇦​​🇹​ ​🇮​ ​🇩​​🇴​:
- **Frontend Development:** Proficient in React, React Native, HTML, CSS, JavaScript/TypeScript, and Figma.
- **Backend Development:** Experience with Node.js, Python, and PHP (Yii).
- **Database Management:** Skilled in SQL and PostgreSQL.
- **Cloud Computing:** Familiar with AWS for server creation, and server deployment on Ubuntu and Windows Server.
